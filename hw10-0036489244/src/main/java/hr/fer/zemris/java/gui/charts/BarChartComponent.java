...
/**
 * Bar graph implementation in a graphic unit interface.
 * 
 * 
 * @author Blaz Bagic
 * @version 1.0
...
public class BarChartComponent extends JComponent {
  ...
  protected void paintComponent(Graphics g) {
    ...
    for (XYValue value : chart.getValues()) {
      ...
      int height = (chart.getMaxY() - chart.getMinY()) / chart.getSpacing() * rowHeight;
      g2d.fillRect((value.getX()-1)*(columnWidth-OFFSET), screenHeight-OFFSET-height, columnWidth, height);
    }
  }
}
